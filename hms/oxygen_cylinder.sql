...
--
-- Table structure for table `oxygen_cylinder`
--

CREATE TABLE `oxygen_cylinder` (
  `name` varchar(500) NOT NULL,
  `address` varchar(1000) NOT NULL,
  `contactno` varchar(500) NOT NULL,
  `numberofrooms` varchar(500) NOT NULL,
  `image` varchar(1000) NOT NULL,
  `oxygencylender` varchar(500) NOT NULL
...
INSERT INTO `oxygen_cylinder` (`name`, `address`, `contactno`, `numberofrooms`, `image`, `oxygencylender`) VALUES
