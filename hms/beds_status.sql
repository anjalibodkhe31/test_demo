...
--
-- Table structure for table `beds_status`
--

CREATE TABLE `beds_status` (
...
--
-- Dumping data for table `beds_status`
--

INSERT INTO `beds_status` (`name`, `address`, `contactno`, `numberofrooms`, `image`, `beds`) VALUES
