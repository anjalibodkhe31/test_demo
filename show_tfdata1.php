...
if(isset($_POST['submit']))
{
    ...
    $email=$_POST['email'];
    $pass=$_POST['pass'];
       $disp="SELECT `email`, `password` FROM `tfm_login` WHERE email='$email' and password='$pass' ";
           ...
           $count = mysqli_num_rows($query);
            $displayq = "SELECT * FROM `tfm_data` WHERE email='$email'";
      ...
      ?>
          ...
          <form action="add_detialtf.php" method="post" target="_blank">
  ...
  <form action="update_tfdetial.php" method="post" target="_blank">
          <lebel style ="position: absolute;  left: 300px; top: 200px;">To upload your detail </lebel>
